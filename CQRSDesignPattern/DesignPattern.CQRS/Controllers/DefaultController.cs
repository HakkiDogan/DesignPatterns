...
namespace DesignPattern.CQRS.Controllers
{
    public class DefaultController : Controller
    {
        ...
        public DefaultController(
            ...
            DeleteProductCommandHandler removeProductCommandHandler,
            ...
            UpdateProductCommandHandler updateProductCommandHandler)
        {
            ...
            _deleteProductCommandHandler = removeProductCommandHandler;
        ...
        {
            var values = _getProductUpdateByIDQueryHandler.Handle(new GetProductByIDQuery(id));
            return View(values);
        }
